...
import styles from "./ViewApplicantsPage2StyleSheet"
import { Image, Text, View } from "react-native"


export default class ViewApplicantsPage2 extends React.Component {
	...
	render() {
		...
		return <View
				...
				<View
					...
					<View
						style={styles.component1430View}>
						<Image
					...
					<Text
						style={styles.totalApplicants999Text}>Total Applicants 99999</Text>
					<Text
